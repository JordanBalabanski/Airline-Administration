const requester = function(){
    ...
    const makeRequest = function(url, data, headers, method){
    data = data || {};
    headers = headers || {};
    url = baseUrl + url;
    ...
    return makeRequest(url, data, headers, 'GET');
    };

    const post = function(url, data, headers){
    return makeRequest(url, data, headers, 'POST');
    };

    const put = function(url, data, headers){
    return makeRequest(url, data, headers, 'PUT');
    };

    const del = function(url, data, headers){
    return makeRequest(url, data, headers, 'DELETE');
    };
